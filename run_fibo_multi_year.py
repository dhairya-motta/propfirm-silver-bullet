...
DATA_PATH = r'C:\Users\kingcuber\.gemini\antigravity-ide\scratch\nsx_cleaned_2010_2024.csv'
...
def run_simulation(years_to_run):
    print(f"\n=============================================")
    ...
    if not df_events.empty:
        ...
        print(f"Final Equity (End of Window): ${account.equity:,.2f} | Phase: {account.phase}")
    else:
